...
sns.distplot(levis_df['rrp'], kde = False, color='blue', label='The levis data', hist_kws={"range": [400, 4000]})
sns.distplot(gstar_df['rrp'], kde = False, color='red', label='The gstar data', hist_kws={"range": [400, 4000]})
